...
int count;
int turn = 0;                    // Shared variable, indicate whose turn it is to execute
bool interested[TOTAL_THREADS];  // Shared variable, indicates processes interested in executing
...
void* myFunction(void* arg)
{
	...
	for(unsigned int i = 0; i < 10; ++i) {
      ...
      //  Make sure that the thread waits for its turn before it enters the critical region.
